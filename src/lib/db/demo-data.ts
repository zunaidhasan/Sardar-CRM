...
const ID = {
  ...
  clients: ["c-2001", "c-2002", "c-2003", "c-2004", "c-2005", "c-2006", "c-2007", "c-2008"],
  ...
  templates: ["t-1001", "t-1002", "t-1003", "t-1004"],
...
export function buildDemoData(): {
  ...
  const clients: Client[] = [
    { id: ID.clients[0]!, user_id: DEMO_USER_ID, name: "Sarah Mitchell", email: "sarah@brightpath.io", company: "BrightPath", platform: "upwork", username: "brightpath", profile_url: "https://www.upwork.com/users/~brightpath", category: "WordPress", account_id: ID.accounts[1]!, tags: ["repeat"], notes: "Prefers daily updates.", created_at: d(-90), updated_at: d(-6) },
    { id: ID.clients[1]!, user_id: DEMO_USER_ID, name: "Tom Hendricks", email: "tom@eleventystudios.com", company: "Eleventy Studios", platform: "fiverr", username: "eleventystudios", profile_url: "https://www.fiverr.com/eleventystudios", category: "Shopify", account_id: ID.accounts[0]!, tags: [], notes: "Budget-conscious, fast approvals.", created_at: d(-120), updated_at: d(-3) },
    { id: ID.clients[2]!, user_id: DEMO_USER_ID, name: "Aisha Rahman", email: "aisha@lumenlabs.co", company: "Lumen Labs", platform: "fiverr", username: "lumenlabs", profile_url: "https://www.fiverr.com/lumenlabs", category: "Landing Page", account_id: ID.accounts[0]!, tags: ["startup"], notes: "Wants 3 revision rounds.", created_at: d(-60), updated_at: d(-2) },
    { id: ID.clients[3]!, user_id: DEMO_USER_ID, name: "Marco Rossi", email: "marco@deltastartups.com", company: "Delta Startups", platform: "upwork", username: "deltastartups", profile_url: "https://www.upwork.com/users/~deltastartups", category: "Web App", account_id: ID.accounts[1]!, tags: ["long-term"], notes: "Series A funded. High quality bar.", created_at: d(-45), updated_at: d(-1) },
    { id: ID.clients[4]!, user_id: DEMO_USER_ID, name: "Nina Patel", email: "nina@kitecrm.io", company: "KiteCRM", platform: "fiverr", username: "kitecrm", profile_url: "https://www.fiverr.com/kitecrm", category: "CRM", account_id: ID.accounts[0]!, tags: ["integration"], notes: "Needs API + frontend.", created_at: d(-35), updated_at: d(-4) },
    { id: ID.clients[5]!, user_id: DEMO_USER_ID, name: "Luis Garcia", email: "luis@verkta.de", company: "Verkta", platform: "upwork", username: "verkta", profile_url: "https://www.upwork.com/users/~verkta", category: "E-commerce", account_id: ID.accounts[1]!, tags: [], notes: "Went with another freelancer on last bid.", created_at: d(-70), updated_at: d(-15) },
    { id: ID.clients[6]!, user_id: DEMO_USER_ID, name: "Emma Johansson", email: "emma@nordkapps.se", company: "Nordk Apps", platform: "fiverr", username: "nordkapps", profile_url: "https://www.fiverr.com/nordkapps", category: "Mobile", account_id: ID.accounts[2]!, tags: ["new"], notes: "From the Fiverr nurture list.", created_at: d(-20), updated_at: d(-20) },
    { id: ID.clients[7]!, user_id: DEMO_USER_ID, name: "David Chen", email: "david@orbitlab.ai", company: "Orbit Lab", platform: "upwork", username: "orbitlab", profile_url: "https://www.upwork.com/users/~orbitlab", category: "AI", account_id: ID.accounts[1]!, tags: ["ai", "startup"], notes: "Interested in AI-assisted features.", created_at: d(-12), updated_at: d(-12) },
  ];
